...
class _HomePageState extends State<HomePage> {
  CloseDialog? _closeDialogController;
  @override
  void initState() {
    _closeDialogController = null;
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AuthBloc, AuthState>(
      listener: (context, state) async{
        if (state is AuthLoading && _closeDialogController==null) {
          _closeDialogController = showLoadingDialog(
            context: context,
            text: "Loading",
          );
          return;
        }else if (_closeDialogController != null) {
          _closeDialogController!();
          _closeDialogController = null;
        }
